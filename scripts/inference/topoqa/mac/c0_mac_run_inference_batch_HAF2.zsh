...
DATASET_NAME="${DATASET_NAME:-HAF2}"
DATASET_DIR="${DATASET_DIR:-../../../../datasets/evaluation/HAF2/decoy}"
GROUND_TRUTH_FILE="${GROUND_TRUTH_FILE:-../../../../datasets/evaluation/HAF2/label_info.csv}"
