...
OUTPUT="output/null_topology2_10A_ARM"
FEATURE_FILE="${REPO_ROOT}/qtdaqa/new_dynamic_features/graph_builder2/feature_configs/null_topology/feature-config.yaml.null2.10A"
