...
OUTPUT="output/partial_lean_10A_edge_min_lean_no_rounding"
FEATURE_FILE="${REPO_ROOT}/qtdaqa/new_dynamic_features/graph_builder2/feature_configs/feature-config.yaml.partial_lean.edge_min_lean.10A"
