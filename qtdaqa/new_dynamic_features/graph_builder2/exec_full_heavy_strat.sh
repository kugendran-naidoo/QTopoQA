...
OUTPUT="output/full_heavy_strat_10A_smaller_chemotype_hbond"
FEATURE_FILE="${REPO_ROOT}/qtdaqa/new_dynamic_features/graph_builder2/feature_configs/feature-config.yaml.full_heavy_stratified.10A"
