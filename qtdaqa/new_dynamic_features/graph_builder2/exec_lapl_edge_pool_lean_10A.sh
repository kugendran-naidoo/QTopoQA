...
OUTPUT="output/lapl_edge_pool_lean_10A"
FEATURE_FILE="${REPO_ROOT}/qtdaqa/new_dynamic_features/graph_builder2/feature_configs/feature-config.yaml.lapl_edge_pool_lean_10A"
