...
OUTPUT="output/null_topology_10A_ARM_small"
FEATURE_FILE="${REPO_ROOT}/qtdaqa/new_dynamic_features/graph_builder2/feature_configs/null_topology/feature-config.yaml.null.10A"
