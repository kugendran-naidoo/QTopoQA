...
OUTPUT="output/advanced_lean_10A_edge_min_lean_ARM"
FEATURE_FILE="${REPO_ROOT}/qtdaqa/new_dynamic_features/graph_builder2/feature_configs/advanced_k_partite_v2/feature-config.yaml.advanced_lean.10A.v2.edge.min.topo.lean"
