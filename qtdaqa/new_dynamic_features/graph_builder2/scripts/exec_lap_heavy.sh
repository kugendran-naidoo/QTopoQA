...
OUTPUT="output/lap_heavy_10A_ARM"
FEATURE_FILE="${REPO_ROOT}/qtdaqa/new_dynamic_features/graph_builder2/feature_configs/advanced_k_partite_lap_only_v2/feature-config.yaml.advanced_lap_only_v2_heavy.10A"
