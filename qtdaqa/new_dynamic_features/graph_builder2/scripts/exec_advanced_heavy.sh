...
OUTPUT="output/advanced_heavy_10A_smaller"
FEATURE_FILE="${REPO_ROOT}/qtdaqa/new_dynamic_features/graph_builder2/feature_configs/feature_configs/advanced_k_partite_v2/feature-config.yaml.advanced_heavy.10A.v2"
