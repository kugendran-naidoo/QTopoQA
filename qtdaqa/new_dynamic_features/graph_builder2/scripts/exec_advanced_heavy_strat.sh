...
OUTPUT="output/advanced_heavy_stratified_10A_smaller"
FEATURE_FILE="${REPO_ROOT}/qtdaqa/new_dynamic_features/graph_builder2/feature_configs/advanced_k_partite/feature-config.yaml.advanced_heavy_stratified.10A"
