...
OUTPUT="output/partial_minimal_10A_smaller"
FEATURE_FILE="${REPO_ROOT}/qtdaqa/new_dynamic_features/graph_builder2/feature_configs/partial_k_partite/feature-config.yaml.partial_minimal.10A"
