...
OUTPUT="output/edge_pool_lean_10A_small_pilot"
FEATURE_FILE="${REPO_ROOT}/qtdaqa/new_dynamic_features/graph_builder2/feature_configs/feature-config.yaml.edge_pool_lean_10A"
