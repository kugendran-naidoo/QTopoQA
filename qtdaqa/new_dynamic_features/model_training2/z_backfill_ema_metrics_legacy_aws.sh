...
# Legacy EMA backfill on AWS (no force; fills missing ema_metrics only).
PYTHON_BIN="${PYTHON_BIN:-python}"
TRAINING_ROOT="/home/app/phd/github/QTopoQA/qtdaqa/new_dynamic_features/model_training2/training_runs2"
export PYTHONPATH="/home/app/phd/github/QTopoQA"

echo "[ema_backfill] legacy (no force) -> ${TRAINING_ROOT}"
