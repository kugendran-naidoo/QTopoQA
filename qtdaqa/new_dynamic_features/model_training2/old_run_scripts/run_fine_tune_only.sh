...
Without arguments, the script scans training_runs2/ (and training_runs2/history/)
...
Optional arguments:
  ...
  --run-dir DIR       Explicit run directory name (under training_runs2/) to
...
if not candidates:
    print("ERROR: No eligible runs found in training_runs2/.", file=sys.stderr)
    sys.exit(1)
