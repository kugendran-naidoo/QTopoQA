...
BUILDER_ID = "graph_builder"
BUILDER_VERSION = "1.0.0"
BUILDER_SCHEMA_VERSION = 1
BUILDER_ENTRYPOINT = "qtdaqa.new_dynamic_features.graph_builder.graph_builder"
...
def build_builder_info(
    *,
    ...
    """Assemble an immutable snapshot describing this builder invocation."""
...
def sanitize_builder_info(builder_info: Dict[str, object], *, include_feature_text: bool) -> Dict[str, object]:
    """Return a deepcopy of builder_info, optionally removing inline config text."""
